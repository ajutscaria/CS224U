...
public class FeatureExtractor {
    ...
    private static final HashMap<String, String> verbForms = Collections.unmodifiableMap(Utils.getVerbForms());
    private static final HashMap<String, Integer> clusters = Collections.unmodifiableMap(Utils.loadClustering());
