...
%\hline
\end{tabular}}
\caption{Test set results on all experiments. $\dagger$ and $\ddagger$ denote statistical significance ($p<0.02$) against \emph{Local$_{base}$} and \emph{Local} baselines, respectively.}
\label{tab:results}
\end{table}
