...
The relation set $\sR$ contains the following (assuming a labeled edge $(u,v,r)$):
...
We annotated 148 process descriptions based on the aforementioned definitions, which can be downloaded from \url{http://to.be.filled.in}. Further details on annotation and data set statistics are provided in Section~\ref{subsec:setup} and Table~\ref{tab:datastats}.
