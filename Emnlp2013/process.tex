...
\item \textsc{Super} denotes that event $u$ includes event $v$. For instance, in ``During \emph{DNA replication}, DNA polymerases \emph{proofread} each nucleotide..." there is an edge (\emph{DNA replication}, \emph{proofread}, \textsc{Super}).
