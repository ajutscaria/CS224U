...
For example, the BioNLP 2009 and 2011 shared tasks \cite{kim09,kim11} consider nine events types that are relevant for proteins. In practice, events are currently almost always extracted from a single sentence.
